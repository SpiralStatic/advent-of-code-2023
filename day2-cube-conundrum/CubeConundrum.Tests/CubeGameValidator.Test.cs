...
public class Tests
{
    ...
    [Test]
    public void MinimumCubesPower_GivenGameRecords_ReturnsExpectedIdSum()
    {
        var gameRecords = new List<string>()
        {
            "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green",
        ...
        var expectedPowerSum = 2286;

        var result = CubeGameValidator.MinimumCubesPower(gameRecords);

        Assert.That(result, Is.EqualTo(expectedPowerSum));
    }
}
